...
def post_event_incidents(event_id: int, participant_id: int, event_incident: EventIncidentCreate, db=Depends(get_db)):
    return event_incident_service.post_incident(event_id, participant_id, event_incident, db)