    ...
    """,
        [
            (
                ...
                d.get("season"),
                d.get("date_venue"),
                d.get("time_venue_UTC"),
                d.get("_stage_id"),
                d.get("_venue_id"),
                d.get("_competition_slug"),
            )
            for d in data
        ],
    )
...
def populate_participant_scores(cur):
    ...
    """,
        [
            (d.get("_participant_id"), d.get("score_value"), d.get("score_label"))
            for d in data
        ],
    )
